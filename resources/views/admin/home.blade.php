                ...
                <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="modal-footer modal-dialog-scrollable p-3 dialog"
                                action="{{ route('admin.news.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <h1 class="smallTitle mb-4" translate="ImportPhoto"></h1>
                                <div class="input-group mb-3">
                                    <input type="file" class="customFileInput" aria-describedby="inputFile"
                                        aria-label="Upload" accept="image/*" required name="image">
                                </div>
