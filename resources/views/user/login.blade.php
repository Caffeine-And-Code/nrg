...
<body>
    <main>
        ...
        <section class="login-section login-zone">
            ...
            <p class="mobile-only">Don't have an account yet?</p>

            
            <button class="btn mobile-only" id="switchRegister">Register</button>
        </section>
        ...
        <section class="registration-zone login-section">
            ...
            <button class="btn mobile-only" id="switchLogin">Login</button>
        </section>
    </main>
</body>
</html>
