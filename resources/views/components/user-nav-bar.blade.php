<nav class="d-flex flex-row justify-content-between">
    ...
    <div class="d-none d-md-flex flex-row align-items-center justify-content-center gap-2">
        ...
        <a href="{{route("user.home")}}" type="button" class="btn navbar-icon @if ($currentPage == "main.products") active @endif"><i class="bi bi-backpack"></i></a>
        <a href="{{route("user.profile")}}" type="button" class="btn navbar-icon @if ($currentPage != "main.products") active @endif"><i class="bi bi-person"></i></a>
    </div>
</nav>
